 ...
 * duoc ve ra. `validatePlaceQuery` o apps/api cung dat 2 — ba tang cung mot so.
 */
 ...
 *
 * `fetch` khong tu bo cuoc. Neu apps/api con giu cong 4000 nhung khong tra loi
 ...
 *
 * 6s chu khong phai 8s: apps/api tu bo cuoc voi Photon o 8s
